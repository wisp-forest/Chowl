...
public class DrawerPanelStorage extends SnapshotParticipant<ItemStack> implements Storage<ItemVariant> {
    ...
    public DrawerPanelStorage(ItemStack stack) {
        this.stack = stack;
    }
    ...
    public long insert(ItemVariant resource, long maxAmount, TransactionContext transaction) {
        ...
        if (component.itemVariant.isBlank() || component.itemVariant.equals(resource)) {
            component.itemVariant = resource;
            component.count = BigInteger.valueOf(maxAmount);
