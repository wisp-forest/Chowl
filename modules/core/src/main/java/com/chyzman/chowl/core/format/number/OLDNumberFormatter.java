...
public class OLDNumberFormatter {
...
//    public static NumberAbbreviationMode abbreviation_mode = NumberAbbreviationMode.LETTERS;
//    public static int digits_before_abbreviation = 6;
//    public static int abbreviation_precision = 2;
//    public static boolean use_commas = true;
//
//    public static String formatCount(BigInteger count) {
//        var digits = BigIntUtils.decimalDigits(count);
//
//        String formatted;
//        if (digits > digits_before_abbreviation && count.compareTo(BigInteger.ZERO) != 0) {
//            formatted = switch (abbreviation_mode) {
...
//        } else formatted = null;
//        if (formatted == null) {
//            return use_commas ? NumberFormat.getNumberInstance(Locale.US).format(count) : count.toString();
